...
export default function AdminUpdatesTab() {
  ...
  function startEditing(update: Update) {
  ...
  async function handleSaveEdit() {
    ...
    if (!title || !content || savingEdit) return
      ...
      <div>
        ...
        <ul className="space-y-3">
          {updates.map((update) => {
            ...
            if (isEditing) {
              return (
                <li key={update.id} className="rounded-xl bg-white p-4 shadow-sm border border-wa-teal/30">
                  <div className="flex flex-col gap-3">
                    <input
                      value={editTitle}
                      ...
                      className="w-full rounded-lg border border-black/10 px-3 py-2.5 text-sm outline-none focus:border-wa-teal font-medium"
                    />
                    <div className="bg-white [&_.ql-container]:min-h-[150px] [&_.ql-container]:text-base [&_.ql-editor]:min-h-[150px] rounded-lg border border-black/10 overflow-hidden focus-within:border-wa-teal flex flex-col">
                    ...
                    <div className="flex justify-end gap-2">
                      <button
                        ...
                        disabled={savingEdit}
                        className="rounded-lg border border-black/10 px-4 py-2 text-sm font-medium text-wa-ink hover:bg-gray-50 disabled:opacity-50"
                      >
                        Cancel
                      </button>
                      <button
